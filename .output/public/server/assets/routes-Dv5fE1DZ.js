...
import { f as getDashboardFn, n as AppShell, t as Card } from "./card-EbVh7PYj.js";
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Button, {
					...
					children: "Google sign-in and email/password are available."
				})]
			}),
			/* @__PURE__ */ jsxs("p", {
...
function SignedInHome() {
	...
	if (!data) return null;
	if ("needsOnboarding" in data || !data.goal) return /* @__PURE__ */ jsx(Navigate, { to: "/onboarding" });
